...
#    D  E  S  C  R  I  P  T  O  N
    ...
    Phone_Model = 'iPhone 11'                       # write iPhone model:  
    ...
    Size = 'XL'  # write package size 'S or M or L or XL' size
    Option = 'XL_PocztaPolska'  # write option of package size for example (S_Orlen, L_inPost, M_PocztaPolska) 
